(function() {
  requirejs.config({
    ...
    paths: {
      ...
      "VMM.FileExtention": "/source/js/core/core/new/VMM.FileExtention",
  ...
  require(["global", "Class", "trace", "VMM", "is_", "type", "VMM.LoadLib", "VMM.Browser", "VMM.Date", "VMM.FileExtention", "VMM.Library", "VMM.Util", "VMM.ExternalAPI", "VMM.Extender", "VMM.MediaElement", "VMM.DragSlider", "VMM.Slider", "VMM.Slider.Slide", "VMM.Timeline", "VMM.Timeline.DataObj", "VMM.Timeline.TimeNav", "Date.extensions", "aes", "bootstrap-tooltip", "leaflet"], function(global, Class, trace, VMM, is_, type, loadLib) {
    var timeline;
